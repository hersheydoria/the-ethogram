export default {
  ...
  tags: ['euthanasia', 'ethics', 'end-of-life care', 'animal welfare', 'compassionate care', 'quality of life', 'veterinary medicine'],
  authors: ['APAAP', 'PAESTE', 'REGIDOR', 'QUINA', 'PADULLION', 'NAMALATA', 'RIVERA', 'TEJADA'],
  relatedLinks: [
  ],
  content: `
    <h2>A Peaceful Goodbye: Veterinarians Speak on Humane Euthanasia and Ethical Decision-Making in Animal Care</h2>

    <p><b>Humane euthanasia</b> is a process of inducing a painless and quick death in an animal suffering from incurable conditions, but behind that lies the biggest question: <i>"Is it ethical?"</i> Ending the life of an animal requires ethical considerations, and thus, it requires highly skilled personnel to perform it. Not every manifestation of suffering warrants euthanasia. It will depend on the degree of distress the animal experiences and how it copes. According to <b>Dr. Xerxes Jordan T. Pizarro</b>, a faculty member of <b>Central Mindanao University, College of Veterinary Medicine (CMU-CVM)</b>, in performing <i>'humane euthanasia,'</i> animals must be seen as equal with humans. <i>"We would not harm the animals in a way that we would not harm people in the same manner,"</i> he added. As the animal welfare standards and societal values continue to evolve, so too does the conversation as to how, when, and why euthanasia should be performed.</p>

    <p>Veterinarians often face difficult moral dilemmas, especially when an animal appears outwardly lively, healthy, and playful. Euthanizing such animals, particularly for research or institutional use, is viewed as ethically problematic. Contrary to common assumptions, euthanasia is emotionally heavy for veterinarians. Many describe it as both an honor and a source of moral stress. They are entrusted with facilitating a peaceful death, yet must navigate their feelings of sadness, responsibility, and the cumulative impact of repeated loss. <b>Dr. Pizarro</b> also experienced the common dilemmas veterinarians faced when facing or performing euthanasia—as an anatomy instructor, it's a common dilemma for him to euthanize animals for the use of scientific discoveries and studies.</p>

    <h2>The Goals of Euthanasia</h2>

    <p>There are certain recommendations and guidelines of euthanasia that are intended to guide veterinarians, who must then use professional judgement in applying them to the various settings where animals are to be euthanized. According to the <b>American Veterinary Medical Association (AVMA)</b>, euthanasia is defined as the act of inducing a rapid, painless, and stress-free death in animals. The overarching goal is to minimize suffering while maintaining the animal's dignity and safety of those present.</p>

    <h2>Guiding Ethical Principles and Justification</h2>
    ...
    <p>Ethical practice dictates that for research or educational needs, professionals should ideally choose animals that are elderly or already frail—if applicable. Euthanizing young animals not only presents a moral challenge but can also compromise the integrity of the studies.</p>
    ...
    <h3>1. Intravenous (IV) Injection of Barbiturates</h3>

    <p>A drug like <b>pentobarbital</b> is injected directly into a vein. The drug quickly reaches the brain and causes the animal to lose consciousness in seconds. After that, the breathing stops, and the heart stops shortly after. The animal feels no pain because it becomes unconscious very fast. It is used because it is fast, reliable, peaceful, and considered the gold standard for dogs, cats, and many other animals.</p>

    <h3>2. Intraperitoneal (IP) Injection</h3>

    <p>The drug is administered right into the peritoneal cavity, which is the potential space within the abdomen and pelvis. It usually takes longer than IV, usually several minutes, leading to the animal becoming unconscious gradually. This is used when the vein is too small or hard to locate and is useful in small animals, wildlife, or sick animals.</p>

    <h3>3. Inhalant Anesthetics (Isoflurane, Sevoflurane)</h3>

    <p>Used mainly for small species like rodents and small birds where injections are difficult. The animal inhales the anesthetic gas and slowly gets sleepy and becomes unconscious; another euthanasia method is used for completing its death.</p>

    <h3>4. Carbon Dioxide (CO₂) Inhalation</h3>

    <p>Commonly used for small laboratory animals. <b>CO₂ gas</b> is introduced gradually into a sealed chamber, ensuring a slow and controlled rise in concentration to prevent pain or distress. The animal first becomes unconscious and then dies shortly after. This method is simple, effective, and safe for small species like mice, rats, and some birds, but it is not recommended for larger animals.</p>

    <h3>5. Captive Bolt</h3>

    <p>Widely used in livestock, including cattle, pigs, and sheep. A penetrating or non-penetrating bolt device is placed against the animal's head and releases a powerful, rapid strike that causes instant brain damage. The animal immediately becomes unconscious, and a second method such as exsanguination or pithing is usually performed to ensure death. This technique is fast, reliable, and practical for large farm animals.</p>

    <h3>6. Gunshot</h3>

    <p>Used in field emergencies or wildlife situations where other methods are not possible. A correctly placed bullet to the brain causes immediate unconsciousness and rapid death. This method requires skill and training to be humane. It is especially useful for large, dangerous, or severely injured animals that cannot be safely restrained for injection.</p>

    <h3>7. Anesthetic Overdose</h3>
