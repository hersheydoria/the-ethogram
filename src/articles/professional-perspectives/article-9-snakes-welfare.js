export default {
  ...
  tags: ['wildlife', 'snakes', 'conservation', 'campus', 'coexistence', 'animal-welfare', 'environmental-education'],
  ...
  content: `
    ...
    <h2>A Rescue That Stayed With Him</h2>
    ...
    <h2>A Campus Alive With Movement</h2>
    ...
    <h2>The Myths That Endanger Snakes</h2>
    ...
    <p>The irony, he points out, is sharp: <i>"Eliminating snakes increases rodent problems and eventually attracts more snakes from outside areas as they follow the food source."</i> Removing snakes does not make anyone safer.</p>

    <h2>Snake Welfare and the Bigger Ecological Picture</h2>

    <p><b>Tevar</b> approaches welfare from both a veterinary and conservation standpoint.</p>

    <p><i>"For the general population, snake welfare starts with stopping the indiscriminate killing. Stress, injury, and unnecessary interference all compromise animal well-being. Correct identification is essential, and relocation should be reserved only for high-risk areas."</i></p>
    ...
    <h2>Coexistence, Distilled to Three Words</h2>
    ...
    <h2>A University's Role</h2>

    <p><b>Tevar</b> believes universities hold a unique position in shaping responsible wildlife interaction.</p>
    ...
    <p><b>Tevar</b> and his team stand at the intersection of two worlds: the one students walk on every day, and the one quietly unfolding beneath the canopy, between the bamboo, or beneath the sheds. Their work reminds <b>CMU</b> that conservation does not always involve grand gestures. Sometimes, it is as simple as pausing, stepping back, and letting an animal continue on its way.</p>

    <p>The campus breathes with these creatures.</p>

    <p>And through the voices of those who understand them, it finally begins to be heard.</p>
  `
}
